...
exports.createHttpRoute = (Clients, options) => {
    return (handler) => {
        ...
        const pipeline = [requestStats_1.trackIncomingRequestStats, cdnNormalizer_1.cdnNormalizer, vary_1.vary, authTokens_1.authTokens, clients_1.clients(Clients, options), setCookie_1.removeSetCookie, timings_1.timings, error_1.error, ...middlewares];
